...
mount hook. See [SSR and hydration](/guides/ssr).

## TypeScript does not recognize `<orb-z>` in React

Add the tag to `React.JSX.IntrinsicElements` as shown in the
[React and Next.js guide](/getting-started/react-next). Do not solve this by
...
Available names are `neongate`, `periwinkle`, `magenta`, `peach`, `mocha`, and
`ivory`.
...
registration. See [Orbz in microfrontends](/guides/microfrontends).
...
use case, open a focused proposal in [GitHub Issues](https://github.com/NeonGate-AI/orbz/issues).
...
[Open an Orbz issue](https://github.com/NeonGate-AI/orbz/issues) · [View the npm package](https://www.npmjs.com/package/@neongate-ai/orbz)
