...
- [x] README and harness documentation describe the explicit `npx --package ... orb` flow and payload exception.
- [x] README distinguishes transient npx execution from project-local `orb` execution.
- [x] The README hero exposes the npx command above centered harness, test, and npm badges.
