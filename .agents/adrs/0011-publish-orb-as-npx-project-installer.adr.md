...
`npx -y @neongate-ai/orbz@latest` both fetches the temporary installer and adds
Orbz to the current project. The published payload intentionally includes shell
